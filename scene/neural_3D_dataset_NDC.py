...
def process_videos(videos, skip_index, img_wh, downsample, transform, num_workers=1):
    ...
    return all_imgs
# rads_scale = 1
def get_spiral(c2ws_all, near_fars, rads_scale=1, N_views=120):
    """
    ...
    # Find a reasonable "focus depth" for this dataset  0.9    5.0
    dt = 0.75
    ...
    render_poses = render_path_spiral(
        c2w, up, rads, focal, zdelta, zrate=0.5, N_rots=3 ,N=N_views
    )
