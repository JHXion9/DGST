...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False):
        ...
        print("Loading Visual Cameras")
        self.visual_camera = FourDGSdataset(scene_info.visual_cameras, args, dataset_type)
    ...
    def getVisualCameras(self, scale=1.0):
        return self.visual_camera